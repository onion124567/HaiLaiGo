package com.common.view.imagepicker.adapter;
...
//            Bitmap bitmap=   memoryCache.get("onion"+imageItem.imageId);
//            Log.i("onion",memoryCache.keys()+"");
//            if (bitmap==null) {
//                bitmap = MediaStore.Images.Thumbnails.getThumbnail(contentResolver,
//                        imageItem.imageId, MediaStore.Images.Thumbnails.MICRO_KIND, null);
//                Log.i("onion", "onion" + imageItem.imageId);
//                memoryCache.put("onion" + imageItem.imageId,bitmap);
//            }
...
//            holder.ivThumb.setImageBitmap(bitmap);
   ...
   // private HashMap<Long, SoftReference<Bitmap>> thumbnailMap = new HashMap<>();
