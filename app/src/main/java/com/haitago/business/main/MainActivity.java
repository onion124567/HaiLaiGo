...
import com.haitago.business.baseandcommon.SlidingFragmentActivity;
import com.haitago.business.map.DriveRouteActivity;
import com.haitago.factory.bean.VersionInfo;
...
public class MainActivity extends SlidingFragmentActivity implements SlidingActivityBase {
    ...
    private int[] menuicon = new int[]{R.drawable.navigation_main, R.drawable.navigation_msg, R.drawable.navigation_group};
    private String[] menutext = new String[]{"接单", "订单", "账户"};
